...
<div class='main_box' style="max-width: 1440px;">
    ...
    <!--     リスト表示エリア -->
    <!--    <div id="output" style="width: 100%; height700px;">-->
    <!--        <ul id="output" class="list-unstyled chat" style="width: 100%; height700px;">-->
    <!--        チャットメッセージ-->
    <!--        </ul>-->
    <!--    </div>-->
    <!--    <div class="input_area">-->
    <!--        <div class="input"><textarea  id="text" cols="32" rows="3" placeholder="メッセージ..."></textarea></div>-->
    <!--        <div class="ss"><button id="send">送信</button></div>-->
    <!--    </div>-->
    <!--</div>-->
  ...
  <!--以下js-->
    ...
    <script>
      ...
      var config = {
        ...
        //firebaseの関数を呼び出す
        newPostRef.ref('{{$team}}/{{$user}}/chatroom').push({//オブジェクトの形で送る
            userid:'{{Auth::user()->id}}',
            name:'{{Auth::user()->name}}',
    ...
    function get(){
        newPostRef.ref('{{$team}}/{{$user}}/chatroom').on('child_added',function(data){
